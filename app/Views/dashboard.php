...
<div class="bg-white min-h-screen w-full">
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-12 sm:py-48 lg:py-12">
        ...
        <div class="absolute inset-x-0 -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
